...
p1 <- ggplot(subset(pow2, eff_xy == 0 & vargx == 0.05 & eff_ux == "Confounder = 0.1"), aes(x=n, y=pow, group=as.factor(paste(test, eff_ux)))) +
geom_point(aes(colour=as.factor(test))) +
geom_line(aes(colour=as.factor(test))) +
facet_grid(. ~ eff_xu) +
scale_colour_brewer(type="qual") +
...
p2 <- ggplot(subset(pow2, n == 10000 & vargx == 0.05 & eff_ux == "Confounder = 0.1"), aes(x=eff_xy, y=pow, group=as.factor(paste(test, eff_ux)))) +
geom_point(aes(colour=as.factor(test))) +
geom_line(aes(colour=as.factor(test))) +
facet_grid(. ~ eff_xu) +
scale_colour_brewer(type="qual") +
geom_hline(yintercept=0.05, linetype="dotted") +
labs(title="A. Power and false discovery rates", x="Simulated causal effect", y="Discovery rate", colour="Method") +
theme_bw() +
...
p3 <- ggplot(subset(pow2, eff_xy == 0.01 & vargx == 0.05 & eff_ux == "Confounder = 0.1"), aes(x=n, y=b-eff_xy, group=as.factor(paste(test, eff_ux)))) +
geom_point(aes(colour=as.factor(test))) +
geom_line(aes(colour=as.factor(test))) +
facet_grid(. ~ eff_xu) +
scale_colour_brewer(type="qual") +
geom_hline(yintercept=0.0, linetype="dotted") +
labs(title="B. Bias", x="Sample size", y="Bias (effect estimate - truth)", colour="Method") +
theme_bw() +
theme(axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.position="none")
